...
async function loadAssetsIndex() {
  try {
    ...
    return data.map(makeAsset).filter((asset) => isDisplayableAsset(asset));
  } catch (error) {
    console.warn("Falling back to embedded assets because the index could not be loaded.", error);
    return buildFallbackAssets().filter((asset) => isDisplayableAsset(asset));
  }
}
...
function renderModal() {
  ...
  const selectedDriveId = getAssetDriveId(selectedDownloadAsset);
  nodes.downloadLink.href = selectedDriveId ? getDownloadUrl(selectedDownloadAsset) : "#";
  if (selectedDriveId) {
    nodes.downloadLink.download = sanitizeFilename(selectedDownloadAsset.title, selectedDownloadAsset.fileFormat);
  } else {
    nodes.downloadLink.removeAttribute("download");
  }
...
function isDisplayableAsset(asset) {
  return Boolean(
...
function buildFallbackAssets() {
  return [
    ...
    makeAsset({
      id: "governon-3d-visual-a-png",
      assetGroupId: "governon-3d-visual-a",
      title: "GovernOn_3D_A",
      brand: "GovernOn",
      fileFormat: "PNG",
      status: "current",
      ...
      locale: "Global",
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2026-01-25T10:04:04.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "GovernOn の 3D Visual 素材です。PNG は ready-to-use の書き出し版です。",
      driveId: "12CDEVCvdLldR9dp9Ujox2XDoeRa34-2l",
    }),
    makeAsset({
      id: "governon-3d-visual-a-psd",
      assetGroupId: "governon-3d-visual-a",
      title: "GovernOn_3D_A",
      brand: "GovernOn",
      fileFormat: "PSD",
      ...
      assetType: "3D Visual",
      usage: ["編集", "制作"],
      updatedAt: "2026-01-25T10:02:50.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "GovernOn の 3D Visual 素材です。PSD は editable source です。",
      driveId: "1dRHMALlTZuK6FzXq1e9cDfNsBHctorz8",
    }),
    makeAsset({
      id: "governon-3d-visual-b-png",
      assetGroupId: "governon-3d-visual-b",
      title: "GovernOn_3D_B",
      brand: "GovernOn",
      fileFormat: "PNG",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2026-01-25T10:02:16.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "GovernOn の 3D Visual 素材です。PNG は ready-to-use の書き出し版です。",
      driveId: "1fio1SkVCkLUMBpYZ8i7XasIdejyi_mPZ",
    }),
    makeAsset({
      id: "governon-3d-visual-e-psd",
      assetGroupId: "governon-3d-visual-e",
      title: "GovernOn_3D_E",
      brand: "GovernOn",
      fileFormat: "PSD",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["編集", "制作"],
      updatedAt: "2026-04-22T09:31:47.235Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "GovernOn の 3D Visual 素材です。PSD は editable source です。",
      driveId: "1mOC5yHQsEzuBqv5MVrpk3ZDpMcvQQR9P",
    }),
    makeAsset({
      id: "governon-3d-visual-f-png",
      assetGroupId: "governon-3d-visual-f",
      title: "GovernOn_3D_F",
      brand: "GovernOn",
      fileFormat: "PNG",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2026-04-22T09:32:02.441Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "GovernOn の 3D Visual 素材です。PNG は final exported asset です。",
      driveId: "12j4oOKte-e6CBS2PxejNZdWoJYI81EjS",
    }),
    makeAsset({
      id: "workon-3d-visual-x3-png",
      assetGroupId: "workon-3d-visual-x3",
      title: "WorkOnX3",
      brand: "WorkOn",
      fileFormat: "PNG",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2026-04-21T11:33:26.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "WorkOn の 3D Visual 素材です。PNG は ready-to-use の書き出し版です。",
      driveId: "14Ks2VReP_kteCVMOzFgrNWxwMZcyLOSY",
    }),
    makeAsset({
      id: "workon-3d-visual-x3-psd",
      assetGroupId: "workon-3d-visual-x3",
      title: "WorkOnX3",
      brand: "WorkOn",
      fileFormat: "PSD",
      ...
      assetType: "3D Visual",
      usage: ["編集", "制作"],
      updatedAt: "2026-04-21T11:33:06.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "WorkOn の 3D Visual 素材です。PSD は editable source です。",
      driveId: "1QRgyfaSsyGUz759lER6y91KuisBLwZo1",
    }),
    makeAsset({
      id: "dealon-3d-visual-saleson-png",
      assetGroupId: "dealon-3d-visual-saleson",
      title: "SalesON",
      brand: "DealOn",
      fileFormat: "PNG",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2025-09-17T19:21:38.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "DealOn の 3D Visual 素材です。PNG は ready-to-use の書き出し版です。",
      driveId: "1raWRR08wNr6egHp3kDrDX03QX00M8QIp",
    }),
    makeAsset({
      id: "dealon-3d-visual-saleson-psd",
      assetGroupId: "dealon-3d-visual-saleson",
      title: "SalesON",
      brand: "DealOn",
      fileFormat: "PSD",
      ...
      assetType: "3D Visual",
      usage: ["編集", "制作"],
      updatedAt: "2025-09-17T19:21:26.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "DealOn の 3D Visual 素材です。PSD は editable source です。",
      driveId: "1rA0UWT9bAAB5v4kQo4tn0Boul_bdqa1I",
    }),
    makeAsset({
      id: "dealon-3d-visual-salesonx3-png",
      assetGroupId: "dealon-3d-visual-salesonx3",
      title: "SalesONx3",
      brand: "DealOn",
      fileFormat: "PNG",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2026-01-29T11:14:38.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "DealOn の 3D Visual 素材です。PNG は ready-to-use の書き出し版です。",
      driveId: "17rOPbkXJmPH75v338PsKJr_WTerHaXxT",
    }),
    makeAsset({
      id: "dealon-3d-visual-salesonx3-psd",
      assetGroupId: "dealon-3d-visual-salesonx3",
      title: "SalesONx3",
      brand: "DealOn",
      fileFormat: "PSD",
      ...
      assetType: "3D Visual",
      usage: ["編集", "制作"],
      updatedAt: "2026-01-29T11:13:54.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "DealOn の 3D Visual 素材です。PSD は editable source です。",
      driveId: "1xarQ8D1IOmLMVut23J6xLPVmQ7bZwloA",
    }),
    makeAsset({
      id: "cxon-3d-visual-main-png",
      assetGroupId: "cxon-3d-visual-main",
      title: "CXON",
      brand: "CXOn",
      fileFormat: "PNG",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2025-09-17T19:28:30.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "CXOn の 3D Visual 素材です。PNG は ready-to-use の書き出し版です。",
      driveId: "1QFlfKCDaA55Rq8RXe324tJijHEwHNJsD",
    }),
    makeAsset({
      id: "cxon-3d-visual-main-psd",
      assetGroupId: "cxon-3d-visual-main",
      title: "CXON",
      brand: "CXOn",
      fileFormat: "PSD",
      ...
      assetType: "3D Visual",
      usage: ["編集", "制作"],
      updatedAt: "2025-09-17T19:28:16.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "CXOn の 3D Visual 素材です。PSD は editable source です。",
      driveId: "1QHoAJsAHrOLe635gHDN5Fl7W-QQRwsBI",
    }),
    makeAsset({
      id: "cxon-3d-visual-ribon-cycle-png",
      assetGroupId: "cxon-3d-visual-ribon-cycle",
      title: "ribon_cycle",
      brand: "CXOn",
      fileFormat: "PNG",
      status: "current",
      ...
      assetType: "3D Visual",
      usage: ["社内資料", "Webサイト", "キャンペーン"],
      updatedAt: "2025-09-11T13:53:12.000Z",
      previousVersionId: null,
      replacedBy: null,
      thumbnailColor: "light",
      description: "CXOn の 3D Visual 補助素材です。PNG の書き出し版です。",
      driveId: "11tFG21p1q2Rp4T2oMhl7Hdh2iw2xdK7C",
    }),
    makeAsset({
