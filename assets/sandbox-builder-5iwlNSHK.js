...
export const SandboxBuilder = () => {
  ...
  const [includeAddContentInGeneratedPageLayout, setIncludeAddContentInGeneratedPageLayout] = useState(false);
  ...
  const pageLayoutJsxText = useMemo(
    () =>
      buildPageLayoutJsxText({
        ...
        globalStyling,
        includeComponents: includeAddContentInGeneratedPageLayout,
        iconNavStart,
      }),
    [
      layout,
      ...
      contentColumnSettings,
      globalStyling,
      includeAddContentInGeneratedPageLayout,
      iconNavStart,
    ],
  );
  ...
  return (
    ...
    >
      <SidebarProvider key={iconNavStart ? "icon-nav" : "normal"} {...(!iconNavStart && { defaultOpen: true })}>
        {editMode === "theme" ? (
          <SidebarInset>
          ...
          <>
            {layout.outerSidebarStart && (
              <Sidebar
                ...
                collapsible={iconNavStart ? undefined : sidebarStartSettings.collapsible}
          ...
          >
            ...
            {isOverrideTab ? (
              ...
              <div
                ...
                style={{
                  display: "grid",
                  gridTemplateRows: tokenTabIndex === 0 ? "auto minmax(0, 1fr)" : "minmax(0, 1fr)",
                  gap: tokenTabIndex === 0 ? "var(--aegis-space-medium)" : undefined,
                  height: "100%",
                  minHeight: 0,
                  inlineSize: "var(--aegis-layout-width-medium)",
                  maxInlineSize: "100%",
                ...
                {tokenTabIndex === 0 ? (
                  <div
                    style={{
                      display: "flex",
                      flexDirection: "column",
                      gap: "var(--aegis-space-2xSmall)",
                    }}
                  >
                    <Checkbox
                      checked={includeAddContentInGeneratedPageLayout}
                      onChange={() => setIncludeAddContentInGeneratedPageLayout((prev) => !prev)}
                    >
                      Include components added in Add content
                    </Checkbox>
                    <Text as="p" variant="body.xSmall" color="subtle">
                      Default output is PageLayout only.
                    </Text>
                  </div>
                ) : null}
                <textarea
