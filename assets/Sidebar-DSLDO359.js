      ...
      <SidebarProvider>
        ...
        <SidebarInset>
          <PageLayout>
            <PageLayoutContent>
              <PageLayoutBody>
                <Placeholder>{"Placeholder ".repeat(300)}</Placeholder>
              </PageLayoutBody>
            </PageLayoutContent>
          </PageLayout>
        </SidebarInset>
...
export const ResizableInlineEnd = {
  ...Open,
  args: {
    resizable: true,
    side: "inline-end",
  ...
  render: (props) => {
    return (
      <SidebarProvider defaultOpen>
        ...
        <SidebarInset>
          <SidebarProvider defaultOpen>
            <Sidebar behavior="push" width="medium" collapsible="offcanvas">
              <SidebarHeader>
                <ContentHeader trailing={<SidebarTrigger />}>
                  <ContentHeaderTitle as="h2">Documents</ContentHeaderTitle>
                </ContentHeader>
