...
export const EmptyNode: Story = {
  parameters: {
    a11y: {
      // Resolved once the listbox is restructured to render empty/loading
      // state in a sibling <status> element rather than as children of
      // <listbox>. See https://github.com/legalforce/aegis/issues/2284
      test: "todo",
    },
  },
  args: {
