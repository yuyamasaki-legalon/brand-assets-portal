 ...
 */
export const ExpandMultiple = meta.story({
  args: {
    defaultIndex: [0],
    multiple: true,
  },
 ...
 */
export const ButtonWidth = meta.story({
  args: {
    children: (
      <AccordionItem>
 ...
 */
export const ButtonIcon = meta.story({
  args: {
    children: (
      <AccordionItem>
        <AccordionButton
...
export const ButtonIconPosition = meta.story({
  args: {
    children: (
      <AccordionItem>
 ...
 */
export const ButtonVariant = meta.story({
  args: {
    children: [
      <AccordionItem key={0}>
...
export const ButtonMultipleLines = meta.story({
  args: {
    children: [
      <AccordionItem key={0}>
        <AccordionButton>
 ...
 */
export const WithPanelCloseButton = meta.story({
  args: {
    children: (
      <AccordionItem>
