var e=`/**
 * Typography Lab local preview fork for compare verification.
 * Source template: src/pages/template/loc/review/index.tsx
 *
 * Compare-specific changes from source template:
 * - 第１条（目的）: variant="body.medium" style={{ fontWeight: "bold" }} → variant="body.medium.bold"
 * - 第２条（秘密情報の定義）: same change
 *
 * DO NOT modify this file for general review layout improvements.
 * All non-typography changes should go to the source template.
 */
import {
  LfAngleDown,
  LfAngleLeft,
...
import type { CheckpointStatus, Severity } from "../../../../../template/loc/review/mock/data";
import { MOCK_ALERT_COUNTS, MOCK_PLAYBOOKS } from "../../../../../template/loc/review/mock/data";

type SeverityFilter = Severity | "all";
type ReviewTab = "risk" | "compliance";

export const ReviewTypographyPreview = () => {
              ...
              >
                ...
                >
                  ...
                  <div style={{ marginTop: "var(--aegis-space-large)" }}>
                    <Text variant="body.medium.bold">第１条（目的）</Text>
                    <Text variant="body.medium" color="subtle">
                  ...
                  <div style={{ marginTop: "var(--aegis-space-large)" }}>
                    <Text variant="body.medium.bold">第２条（秘密情報の定義）</Text>
                    <Text variant="body.medium" color="subtle">
