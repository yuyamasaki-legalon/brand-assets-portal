var e=`import { LfClip, LfDownload, LfPrint, LfSend, LfSetting, LfSparkles } from "@legalforce/aegis-icons";
import {
  Avatar,
  Button,
  ButtonGroup,
...
export default function AiChat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      id: "welcome",
      type: "agent",
      text: "Hello! I'm your AI assistant. You can ask me to make a reservation, calculate commute routes, or create an employment certificate. Try saying 'Make a reservation with A restaurant', '従業員の通勤経路を計算して', or '在職証明書の記入案を作成して'",
    },
  ]);
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: messages.length is needed to detect when messages change
  useEffect(() => {
