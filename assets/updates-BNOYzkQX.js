...
const aegisVersions = [
  {
    ...
    description:
      "Textarea ghost option, RadioGroup preview components, Link fit-content in flex/grid, DataTable Manage columns 非表示",
    date: "2026-06",
  },
  {
    version: "v2.51.1",
    path: "/updates/aegis-releases/v2-51-1",
    description: "Combobox / TagPicker filter guidance caption, Breadcrumb IconButton サイズ統一",
    date: "2026-05",
  },
  {
    version: "v2.51.0",
    path: "/updates/aegis-releases/v2-51-0",
    description: "DataTable columnVirtualization, CardLink disabled, Card outline opaque background",
    date: "2026-05",
  },
  {
    version: "v2.50.0",
    path: "/updates/aegis-releases/v2-50-0",
    description: "Tag dash variant, cloud slash/xmark icons, Stepper/createCollection 内部改善",
    date: "2026-05",
  },
  {
    version: "v2.49.0",
    ...
    description:
      "Sidebar semiSmall 幅追加, ShimmerText 追加, a11y セマンティクス改善, Skeleton.Text/Button/Table 非推奨化",
    date: "2026-05",
  },
  {
    version: "v2.48.3",
    path: "/updates/aegis-releases/v2-48-3",
    description: "Sidebar data-slot 属性追加, transition 判定修正, PageLayout の grid 化, spacer 内部追加",
    date: "2026-05",
  },
  {
    version: "v2.48.0",
