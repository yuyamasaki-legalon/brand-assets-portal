  ...
  render: (args) => {
    ...
    return (
      <Stack>
        <DataTable
          {...args}
          badgedRows={showBadges ? args.badgedRows : undefined}
        />
        <Button
          onClick={() => {
 ...
 * - Column Virtualization (columnVirtualization)
 */
...
export const ColumnVirtualization = {
  args: {
    columnVirtualization: true,
    stickyHeader: true,
    columns: (
      ["name", "username", "organization", "country", "title", "bio"] as const
    ).flatMap((key) => {
