...
const InputToolbar: FC<{
  disabled?: boolean;
  isStreaming?: boolean;
  draftEnabled?: boolean;
  onToggleDraft?: () => void;
}> = ({ disabled, isStreaming, draftEnabled = false, onToggleDraft }) => (
  <div style={styles.inputToolbar}>
    <ButtonGroup variant="plain" size="small">
      ...
      <Tooltip title="ドラフトモード">
        <Button
          variant="subtle"
          size="small"
          aria-label="ドラフトモード切り替え"
          aria-pressed={draftEnabled}
          color={draftEnabled ? "information" : "neutral"}
          leading={
            <Icon size="small">
              <LfFileEdit />
            </Icon>
      ...
      <Button variant="plain" size="small" leading={LfEarth} aria-label="検索範囲のメニューを開く">
        すべてのソース
      </Button>
    </ButtonGroup>
    <ButtonGroup variant="plain" size="small">
      ...
      {isStreaming ? (
        <Tooltip title="回答生成をキャンセルする">
          <IconButton aria-label="回答生成をキャンセルする" variant="solid">
            <Icon>
              <LfSquareFill />
            </Icon>
          </IconButton>
        ...
        <Tooltip title="送信">
          <IconButton aria-label="送信" disabled={disabled} variant="solid">
            <Icon>
              <LfSend />
            </Icon>
          </IconButton>
