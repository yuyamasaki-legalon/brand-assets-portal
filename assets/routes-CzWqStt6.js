var e=`import { lazy, type ReactElement } from "react";
...
const ComponentGallery = lazy(() =>
  import("./component-gallery/index").then((module) => ({ default: module.ComponentGallery })),
);
...
const sandboxPageRoutes: SandboxPageRoute[] = [
  ...
  {
    path: "/sandbox/wataryooou/component-gallery",
    element: <ComponentGallery />,
    filePath: "src/pages/sandbox/users/wataryooou/component-gallery/index.tsx",
  },
];
