var e=`export type Severity = "low" | "medium" | "high";
...
export const MOCK_LANGUAGES: FilterOption[] = [
  { value: "ja", label: "日本語" },
...
export const MOCK_POSITIONS: FilterOption[] = [
  { value: "discloser", label: "開示者" },
  { value: "recipient", label: "受領者" },
  { value: "both", label: "双方" },
];

export const MOCK_GOVERNING_LAWS: FilterOption[] = [
...
export const ACTION_TYPE_LABEL_MAP: Record<RuleActionType, string> = {
  insertion: "抜け落ち",
  addition: "追加",
  deletion: "削除",
  revision: "修正",
