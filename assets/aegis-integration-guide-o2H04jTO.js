var e=`# Aegis Design System Integration Guide
...
\`\`\`
mcp__aegis__get_component_details("Button")
\`\`\`
...
| \`mcp__aegis__get_component_details\` | Get detailed component info (props, examples) |
