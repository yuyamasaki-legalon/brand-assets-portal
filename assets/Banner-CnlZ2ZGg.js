...
const ALL_SIZES: BannerProps["size"][] = ["large", "medium", "small", "xSmall"];
/**
...
/**
 * Use the \`icon\` prop of the \`Banner\` to replace the default icon with a custom element.
 */
export const CustomIcon = {
  args: {
    icon: <StatusLabel size="small">Trial</StatusLabel>,
    inline: true,
    children:
      "You can create up to 3 conversations per month (this is the 1st)",
  },
  render: (props) => (
    <Stack>
