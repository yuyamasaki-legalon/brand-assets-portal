 ...
 * Source template: src/pages/template/chat-layout/index.tsx
 *
 * Compare-specific changes from source template:
 * - UserMessage body text: <Text> → <Text variant="body.medium">
 * - AssistantMessage content text: same variant addition
 * - AssistantMessage loading text: <Text color="subtle"> → <Text variant="body.medium" color="subtle">
 *
 * DO NOT modify this file for general chat layout improvements.
...
export const ChatLayoutTypographyPreview: FC = () => {
