var e=`import { LfArrowRight } from "@legalforce/aegis-icons";
  ...
  return (
    <div style={{ width: "100vw", height: "100vh", display: "flex" }}>
      {/* Hide ReactFlow handles (connection dots) - ScreenNode is shared, so override via CSS.
          ReactFlow が内部で style 属性をインライン付与するため、例外的に !important を許可する。 */}
      {/* eslint-disable aegis-custom/no-important -- ReactFlow inline style override */}
      <style>
        {\`
