var e=`import { LfPlusLarge, LfTrash } from "@legalforce/aegis-icons";
import {
  Accordion,
  Banner,
  Button,
      ...
      <PageLayout>
        ...
        <PageLayoutContent>
          ...
          <PageLayoutBody>
            ...
            >
              <ProfileRetrievalJobStatusBanner />
...
const ProfileRetrievalJobStatusBanner = () => (
  <Banner color="information" closeButton={false} aria-label="情報を更新中です">
    <Text whiteSpace="pre-wrap">
      {"情報を更新中です。時間をおいて画面を更新してください。\\n更新中は内容の編集はできません。"}
    </Text>
  </Banner>
);
