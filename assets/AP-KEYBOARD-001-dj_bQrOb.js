...
Space キーは既定でページスクロールを発生させるため、\`onKeyDown\` 内で \`e.preventDefault()\` を呼んでスクロールを抑止する必要がある（[WAI-ARIA APG Button Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/button/) 参照）。
`;export{e as default};