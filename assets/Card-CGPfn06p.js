  ...
  render: (props) => (
    <Stack>
      {ALL_VARIANTS.map((variant) => (
        <Card key={variant} {...props} variant={variant} />
      ))}
    </Stack>
  ),
});

export const WithHeaderLeading = meta.story({
  args: {
    children: (
      <CardHeader
        leading={
...
export const WithHeaderTrailing = meta.story({
  args: {
    children: (
...
export const WithLink = Variant.extend({
  args: {
    children: [
      <CardHeader
        key={0}
...
export const WithDisabledLink = Variant.extend({
  args: {
    children: (
      <CardHeader>
        <CardLink href="#" disabled>
          Design System
        </CardLink>
      </CardHeader>
    ),
...
export const LinkAsButton = Variant.extend({
  args: {
    children: [
      <CardHeader
        key={0}
...
export const LinkAsToggleButton = meta.story({
  args: {
    children: [
      <CardHeader
        key={0}
...
export const NestedCardWithCardLinkButton = meta.story({
  render: (props) => (
    <Card {...props}>
...
export const WithinGrid = meta.story({
  args: {
    children: (
      <CardHeader
        leading={
