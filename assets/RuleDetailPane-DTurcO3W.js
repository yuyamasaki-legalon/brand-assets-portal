var e=`// NOTE: PageLayout.Pane 内で PageLayout.Header/Body を div でラップすると
// スクロールコンテナの計算が崩れ、Header が固定されずに Body と一緒にスクロールしてしまう。
// 本番環境でも同様の問題が発生している。Fragment で返すのが正しいパターン。
