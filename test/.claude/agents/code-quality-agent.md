...
<!-- Source: .claude/rules/typescript.md（ルールの原本） -->

TypeScript strict mode、`any` 禁止、未使用変数削除、`import type` 使用、Biome フォーマット（2スペース、ダブルクォート、セミコロン、120文字幅）。
詳細は `.claude/rules/typescript.md` を参照。
