  ...
  return (
    <NavList>
      ...
      <NavList.Group title="マターマネジメント">
        ...
        <NavList.Item href="/template/personal-setting/legalscape" aria-current="page">
          Legalscape連携
        </NavList.Item>
      </NavList.Group>
...
// Main Legalscape Page Component
export const LegalscapePage = () => {
  return (
    <LocSidebarLayout activeId="others">
      <PageLayout>
        ...
        <PageLayoutContent>
          <PageLayoutHeader>
            <ContentHeader>
              <ContentHeaderTitle>Legalscape連携</ContentHeaderTitle>
            </ContentHeader>
          </PageLayoutHeader>
